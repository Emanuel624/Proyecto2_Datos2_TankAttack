...
constexpr auto qt_meta_stringdata_CLASSTankENDCLASS = QtMocHelpers::stringData(
    "Tank",
    "tankSelected",
    "",
    "Tank*",
...
void Tank::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->tankSelected((*reinterpret_cast< std::add_pointer_t<Tank*>>(_a[1]))); break;
        case 1: _t->movementCompleted(); break;
        default: ;
        }
        ...
        {
            using _t = void (Tank::*)(Tank * );
            if (_t _q_method = &Tank::tankSelected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Tank::*)();
            if (_t _q_method = &Tank::movementCompleted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Tank::tankSelected(Tank * _t1)
{
